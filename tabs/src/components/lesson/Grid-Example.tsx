...
const images = [
    ...
    <Image
        key="henry"
        fluid
        src="https://fabricweb.azureedge.net/fabric-website/assets/images/avatar/HenryBrill.jpg"
    />,
    <Image
        key="isaac"
        fluid
    ...
    <Image
        key="lydia"
        fluid
        src="https://fabricweb.azureedge.net/fabric-website/assets/images/avatar/LydiaBauer.jpg"
    />,
    <Image
        key="mauricio"
        fluid
    ...
    <Image
        key="mona"
        fluid
        src="https://fabricweb.azureedge.net/fabric-website/assets/images/avatar/MonaKane.jpg"
    />,
]
